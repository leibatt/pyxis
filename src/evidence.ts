...
export interface Evidence {
  name: string;
  description?: string;
  timestamp: number; // to keep track of when the evidence was created;
  ...
  sourceRecordsUsed?: () => {dataset: BaseDataset, recordsUsed: DataRecord[]}[]; // the original source records used by this evidence
