...
const baltimoreCrimes: Dataset = loadDataset("BPD_Part_1_Victim_Based_Crime_Data2.json","baltimoreCrimes");
...
const prediction_result: ValueType = dtrm.predict(baltimoreCrimes.records[0]);
